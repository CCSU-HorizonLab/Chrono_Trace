...
- **修复进展（2026-09-25）**：P1–P5 已修（W1/W2/W3、A2、R1/R2、F1/F2/F7、A1/A5、G1/G2）；⑥批次已修（R3/R4/R5/R7、G3–G8、L1/L2/L5/L6、B1–B4、L3/B5、A3/A4/A6/A7/A8、F3/F4/F5/F6、S1–S5、M1 lint 清理 118 处；另补修 L2 同类泄漏点 generate_quick_prompts 与 F8（bridge.ts 声明漂移：移除后端不存在的 get_dashboard_stats、补齐 affinity.ts 实际调用的 14 个方法声明）。未修遗留：G8 提取侧（核实无消费方，无需改）、10 处 F841 已知良性死变量。
