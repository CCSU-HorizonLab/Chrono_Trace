...
- [x] 当前运行库已重建联系人 `7191` 的 799 条 768 维事实向量；修正版 smoke 回放报告见 `rag-v4-runtime-smoke-v6-report.json`。
- [ ] 泛化问句的 gold 仍需扩展为“所有语义相关事实”而非只指定单一 fact ID，完成后再重新校准 Recall/MRR 门禁。
