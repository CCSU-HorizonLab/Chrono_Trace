...
type PyWebViewApi = {
  ...
  start_wechat_db_key_capture: (account_wxid?: string, timeout_seconds?: number) => Promise<any>
  ...
  get_contact_facts: (conversation_id: number, account_wxid?: string, limit?: number, offset?: number, sort?: string, kind?: string) => Promise<any>
